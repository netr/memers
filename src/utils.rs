...
impl Gas {
    ...
    pub fn new(gas_used: u64, base_fee: u64, max_fee: u64, max_prio_fee: u64) -> Self {
    ...
    pub async fn from_h256(provider: Provider<Http>, hash: H256) -> Result<Gas> {
        ...
        let gas = Gas::new(
            receipt.gas_used.unwrap().as_u64(),
            block.base_fee_per_gas.unwrap().as_u64(),
            tx.max_fee_per_gas.unwrap().as_u64(),
            tx.max_priority_fee_per_gas.unwrap().as_u64(),
        );
    ...
    pub fn max_priority_fee(&self) -> u64 {
        self.max_prio_fee
    }
...
mod tests {
    ...
    fn it_should_display_gas_properly() {
        ...
        let base_fee = 8681938922;
        let gas_used = 182197;
        let max_fee = 9121299698;
        let max_prio_fee = 50000000;
